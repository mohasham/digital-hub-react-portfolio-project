    ...
    <footer className="app-footer">
      <div className="app-footer__container">
        <div className="app-footer__branding">
          ...
          <p className="app-footer__tagline">Full-Stack Web Developer — always learning, always building.</p>
        ...
        <div className="app-footer__socials">
          ...
          >
            ...
            <span className="app-footer__social-label">GitHub</span>
          </a>
          <a
            className="app-footer__social"
            href="https://www.linkedin.com/in/mohammad-shamma/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
          >
            ...
            <span className="app-footer__social-label">LinkedIn</span>
          </a>
          <a
            className="app-footer__social"
            href="mailto:mohammadshamma298@gmail.com"
            aria-label="Email"
          >
            <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true">
              <path d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6zm-2 0-8 5-8-5h16zm0 12H4V8l8 5 8-5v10z" />
            </svg>
            <span className="app-footer__social-label">Email</span>
          </a>
        </div>
      </div>
    </footer>
